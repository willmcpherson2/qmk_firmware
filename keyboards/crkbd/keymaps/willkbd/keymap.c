...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //|---------|---------|---------|---------|---------|---------|    |---------|---------|---------|---------|---------|---------|
        KC_ESC  , KC_F1   , KC_F2   , KC_F3   , KC_F4   , KC_F5   ,      KC_MPLY , KC_MPRV , KC_VOLD , KC_VOLU , KC_MNXT , KC_BSPC ,
    //|---------|---------|---------|---------|---------|---------|    |---------|---------|---------|---------|---------|---------|
        KC_TAB  , KC_GRV  , KC_MINS , KC_EQL  , KC_LBRC , KC_RBRC ,      KC_BSLS , KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT , KC_QUOT ,
    //|---------|---------|---------|---------|---------|---------|    |---------|---------|---------|---------|---------|---------|
